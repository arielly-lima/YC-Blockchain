...
O modelo combina receita institucional e financiamento de impacto para manter uma trilha gratuita. **Áudios brutos não são produto e não devem ser vendidos.**

## Quem pode pagar

| Segmento | Oferta possível |
| --- | --- |
| clínicas e profissionais | assinatura do painel e personalização |
...
```text
receita institucional + patrocínio
  → operação e infraestrutura
  → vagas gratuitas ou supervisionadas
...
1. Interesse de clínicas no painel profissional.
2. Custo de personalização por criança.
...
A sustentabilidade não pode depender da exploração comercial da voz infantil. O valor econômico deve vir dos serviços, da infraestrutura e dos resultados oferecidos às instituições.
