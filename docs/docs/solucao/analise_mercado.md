...
description: Ecossistema, alternativas e oportunidades institucionais
sidebar_position: 4
---
...
O caminho inicial recomendado é:
...
- ciclo longo de contratação institucional;
- exigências regulatórias e éticas;
- custo de processamento de áudio;
- necessidade de evidência técnica robusta;
- baixa confiança se o consentimento for complexo;
